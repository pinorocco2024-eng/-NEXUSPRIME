export default async function handler(req, res) {
  ...
  try {
    ...
    const SYSTEM_TEXT =
      "Rispondi SEMPRE in italiano. Sei un assistente del sito NEXUS Prime. " +
      "Tono: chiaro e professionale. Fai UNA domanda alla volta quando mancano dettagli. Non inventare.";
