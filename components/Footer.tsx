      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          <div className="lg:col-span-1">
            <h2
              className="text-3xl font-black mb-8 tracking-tighter cursor-pointer"
          ...
          <div>
            <h4 className="font-bold mb-8 text-xs uppercase tracking-[0.3em] text-slate-400">
              Products
            </h4>
            <ul className="space-y-4">
              <li>
                <button
                  onClick={() => onNavigate?.("service-quant")}
                  className="text-slate-500 hover:text-cyan-400 transition-colors text-left"
                >
                  Quantum Trading
                </button>
              </li>
              <li>
                <button
                  onClick={() => onNavigate?.("prod-custody")}
                  className="text-slate-500 hover:text-cyan-400 transition-colors text-left"
                >
                  Digital Custody
                </button>
              ...
              <li>
                <button
                  onClick={() => onNavigate?.("prod-wallets")}
                  className="text-slate-500 hover:text-cyan-400 transition-colors text-left"
                >
                  Smart Wallets
                </button>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <button
                  onClick={() => onNavigate?.("res-reports")}
                  className="text-slate-500 hover:text-cyan-400 transition-colors text-left"
                >
                  Market Reports
                </button>
              ...
              <li>
                <button
                  onClick={() => onNavigate?.("res-whitepaper")}
                  className="text-slate-500 hover:text-cyan-400 transition-colors text-left"
                >
                  Whitepaper
                </button>
          ...
          <div>
            ...
            <div className="flex flex-col gap-6">
              <div
                ...
                onClick={() => onNavigate?.("service-bio")}
              >
              ...
              <div
                className="flex items-center gap-4 group cursor-pointer"
                onClick={() => onNavigate?.("service-liquid")}
              >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-12 border-t border-white/5 text-[10px] tracking-[0.4em] text-slate-700 uppercase">
          ...
          <a
            href="https://www.genzcreation.it"
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 md:mt-0"
          >
            sito realizzato da <span className="text-pink-400">GenzCreation</span>
          </a>

          <div className="flex gap-12 mt-6 md:mt-0">
            <button
              onClick={() => onNavigate?.("res-risk")}
